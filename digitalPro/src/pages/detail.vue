    ...
    <div class="detail-wrap">
        <div class="detail-left">
            <div class="product-board">
                <img :src="productIcon" alt="product-pic">
                <ul>
                    <!--<li v-for="item in products">{{ item.name }}</li>-->
                    <router-link v-for="item in products" :key="'item'" :to="{path:item.path}" tag="li" active-class="active">{{ item.name }}</router-link>
                </ul>
            </div>
        </div>
...
<style>
    ...
    /*child components: analysis, count, forecast, publish*/
    .sales-board {
        background: #fff;
    }
